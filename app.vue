  ...
  <main class="dark:bg-zinc-900 bg-gray-100">
    ...
    <footer class="container !mb-0 pb-12">
      <div class="social-links gap-2 sm:gap-4">
        ...
        <NuxtLink
          to="https://discord.gg/He3jpV9uvg"
          target="_blank"
          rel="noreferrer"
          class="dark:!border-zinc-400 dark:!text-zinc-400 dark:hover:!text-zinc-900 dark:hover:!bg-zinc-400"
        >
        ...
        <NuxtLink
          to="https://instagram.com/thoanny__"
          target="_blank"
          rel="noreferrer"
          class="dark:!border-zinc-400 dark:!text-zinc-400 dark:hover:!text-zinc-900 dark:hover:!bg-zinc-400"
        >
      ...
      >
        <div class="text-center sm:text-left dark:text-zinc-400">
          Fait avec ❤, TailwindCSS, DaisyUI, Nuxt et Vercel &copy; Thoanny
          {{ currentYear }}
        </div>
    ...
    >
      <div class="modal-box p-0 text-lg sm:!max-w-xs dark:bg-zinc-800">
        <ul
          class="menu bg-base-100 w-full p-2 rounded-box dark:bg-zinc-800 dark:text-zinc-200"
        >
          <li>
            <NuxtLink
              to="/"
          ...
          <li>
            <NuxtLink
              to="/categories/jeux-video"
              @click="menuModalClose"
              class="dark:hover:bg-zinc-700 dark:active:text-neutral dark:active:bg-primary"
              ><span>🎮</span>Jeux vidéo
            </NuxtLink>
          </li>
          <li>
            <NuxtLink
              to="/categories/streaming"
              @click="menuModalClose"
              class="dark:hover:bg-zinc-700 dark:active:text-neutral dark:active:bg-primary"
              ><span>🟣</span>Streaming
            </NuxtLink>
