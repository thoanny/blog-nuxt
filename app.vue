    ...
    <label for="modal-menu" class="modal cursor-pointer modal modal-bottom sm:modal-middle">
      <div class="modal-box p-0 text-lg sm:!max-w-xs">
        <ul class="menu bg-base-100 w-full p-2 rounded-box">
          <li>
            <NuxtLink to="/" @click="menuModalClose"><span>📃</span>Blog</NuxtLink>
          </li>
          <li>
            <NuxtLink to="/categories/projets" @click="menuModalClose"><span>🛠️</span>Projets</NuxtLink>
          </li>
          <li>
            <NuxtLink to="/categories/jeux-video" @click="menuModalClose"><span>🎮</span>Jeux vidéo</NuxtLink>
          </li>
          <li>
            <NuxtLink to="/categories/streaming" @click="menuModalClose"><span>🟣</span>Streaming</NuxtLink>
          </li>
          <li>
            <NuxtLink to="/twitch" @click="menuModalClose"><span>📺</span>Twitch</NuxtLink>
          </li>
          <li>
            <NuxtLink to="https://ko-fi.com/thoanny" target="_blank" rel="noreferrer"><span>☕</span>Me soutenir</NuxtLink>
          </li>
        </ul>
      </div>
    </label>
