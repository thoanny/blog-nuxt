  ...
  <main class="dark:bg-zinc-900 bg-gray-100">
    ...
    <header class="bg-primary dark:bg-accent">
      <div class="container h-full !my-0">
        ...
        <nav>
          ...
          <a class="btn bg-white border-white text-black hover:text-white rounded-full" href="https://ko-fi.com/thoanny"
            target="_blank" rel="noreferrer">☕ Me soutenir</a>
        </nav>
      </div>
    </header>
    ...
    <footer class="container !mb-0 pb-12">
      <div class="social-links">
        <!-- Twitch -->
        <a href="https://twitch.tv/thoanny" target="_blank" rel="noreferrer">
        ...
        <!-- Discord -->
        <a href="https://discord.gg/He3jpV9uvg" target="_blank" rel="noreferrer">
        ...
        <!-- Twitter -->
        <a href="https://twitter.com/thoanny_" target="_blank" rel="noreferrer">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor">
            <path
        ...
        <!-- Instagram -->
        <a href="https://instagram.com/thoanny__" target="_blank" rel="noreferrer">
        ...
        <!-- Github -->
        <a href="https://github.com/thoanny" target="_blank" rel="noreferrer">
