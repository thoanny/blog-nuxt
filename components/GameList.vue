...
<template>
    <div class="bg-base-100 shadow-xl block sm:flex justify-between items-center gap-2 p-2 mb-4 rounded-lg">
        <div class="flex items-center gap-2 mb-4 sm:mb-0">
            <div class="avatar" v-if="game.thumbnail">
                <div class="w-16 h-16 rounded">
                    <img :src="game.thumbnail" class="object-cover w-full h-full" alt="" loading="lazy" />
                </div>
            </div>
            <div class="flex flex-col gap-2">
                <h2 class="text-lg font-bold leading-5">
                    {{ game.name }}
                </h2>
